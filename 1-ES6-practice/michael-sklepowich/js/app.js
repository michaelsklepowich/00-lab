...
function displayPics(){
  ...
  // This line of code would throw an error because the keyword "let" cannot be used twice (with the same name) within the same scope.
  // In this instace, the let keyword was used once at the begining of the while loop, and iterrating through causes an error.
  console.log(viewed)
